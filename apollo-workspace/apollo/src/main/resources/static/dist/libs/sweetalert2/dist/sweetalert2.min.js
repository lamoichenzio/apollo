! function(t, e) {
    ...
    function Zt(t, e, n) {
        t.removeEventListener(dt, Zt), S(t, k.hide) && Ft(e, n), Yt(ht), Yt(Kt)
    }
    ...
    function Qt(t) {
        var e = q(),
            ...
            r = o.onClose,
            a = o.onAfterClose;
        n && !S(n, k.hide) && (null !== r && "function" == typeof r && r(n), ot(n, k.show), nt(n, k.hide), dt && j(n) ? n.addEventListener(dt, Zt.bind(null, n, e, a)) : Ft(e, a), i(t || {}), delete this.params)
    }
    var Yt = function(t) {
    ...
    }), ue.DismissReason = C, ue.version = "8.10.3";
    var ce = ue;
